...
class GoogleImages
{
    ...
    private function output($images, $cols = 5, $rows = 15){
        //creating table
        echo "<table border='0'>";
        for($i=0; $i < $rows; $i++)
        {
            ...
            for($j=0; $j < $cols; $j++)
            {
                ...
                "' target='blank'>Check this one</a></td>";
            }
            echo "</tr>";
        }
        echo "</table>";
    ...
    public function get_images($query, $cols = 5, $rows = 15){
        ...
        {
            $urls[$i] = 'http://ajax.googleapis.com/ajax/services/search/images?v=2.0&q=';
